<template>
    <div @mouseover="mouseover" :class="'run-scrollbar' + ( this.classes ? ' ' + this.classes : '' )" ref="scrollWrapper" :style="this.styles">
		<div :class="'run-scrollbar__area' + ( this.dragging ? ' ' : ' run-scrollbar-transition')" ref="scrollArea" @wheel="scroll" @touchstart="startDrag" @touchmove="onDrag" @touchend="stopDrag"
        :style="{
    ...
    methods: {
        ...
        normalizeVertical(next) {
            ...
            if (shouldScroll) {
                (this.top = next),
                    (this.vMovement =
                        next / elementSize.scrollAreaHeight * 100 || 0);
        ...
        normalizeHorizontal(next) {
            ...
            // Horizontal Scrolling
            const rightEnd =
                elementSize.scrollAreaWidth - this.scrollWrapperWidth;
            ...
            if (shouldScroll) {
                (this.left = next),
                    (this.hMovement =
                        next / elementSize.scrollAreaWidth * 100 || 0);
